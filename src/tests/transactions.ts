...
export function buildMockedNetworkProvider(options?: buildNetworkProviderOptions) {
  const {
    ethChainId,
    ethAccounts,
    ethEstimateGas,
  ...
  return {
    request: jest.fn().mockImplementation(({ method }: { method: string; params: string[] }) => {
      switch (method) {
        case 'eth_chainId':
          return ethChainId ?? Promise.resolve('0x13881')
        case 'eth_accounts':
          return ethAccounts ?? Promise.resolve(['0x7309F0134f3e51E8CBE29dD86068e0F264F6c946'])
        case 'eth_estimateGas':
          return ethEstimateGas ?? Promise.resolve('0x5208')
        case 'eth_sendTransaction':
          return ethSendTransaction ?? Promise.resolve('0xc9dd675b8949ce5d18b6cb4c9df888bb4c37ca02bbe54eb42d2b42514a0967c5')
