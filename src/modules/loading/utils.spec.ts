...
describe('modules', function () {
  describe('loading', function () {
    describe('utils', function () {
      ...
      const elements = [{ type: 'A' }, { type: 'B' }, { type: 'C' }, { type: 'B' }, { type: 'A' }]

      describe('removeLast', function () {
        it('should remove the forth element', function () {
          const newElements = removeLast(elements, element => element.type === 'B')
          expect(newElements).toEqual([{ type: 'A' }, { type: 'B' }, { type: 'C' }, { type: 'A' }])
        })

        it('should remove the third element', function () {
          const newElements = removeLast(elements, element => element.type === 'C')
          expect(newElements).toEqual([{ type: 'A' }, { type: 'B' }, { type: 'B' }, { type: 'A' }])
        })

        it('should remove the last element', function () {
          const newElements = removeLast(elements, element => element.type === 'A')
          expect(newElements).toEqual([{ type: 'A' }, { type: 'B' }, { type: 'C' }, { type: 'B' }])
        })

        it('should not remove any element', function () {
          const newElements = removeLast(elements, element => element.type === 'D')
          expect(newElements).toEqual([{ type: 'A' }, { type: 'B' }, { type: 'C' }, { type: 'B' }, { type: 'A' }])
        })
      })
