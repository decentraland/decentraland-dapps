...
export const enableWalletRequest = (providerType: ProviderType) => action(ENABLE_WALLET_REQUEST, { providerType })
export const enableWalletSuccess = (providerType: ProviderType) => action(ENABLE_WALLET_SUCCESS, { providerType })
export const enableWalletFailure = (error: string) => action(ENABLE_WALLET_FAILURE, { error })
...
export const changeAccount = (wallet: Wallet) => action(CHANGE_ACCOUNT, { wallet })
export type ChangeAccountAction = ReturnType<typeof changeAccount>

export const CHANGE_NETWORK = 'Change Network'
export const changeNetwork = (wallet: Wallet) => action(CHANGE_NETWORK, { wallet })
...
export const disconnectWalletFailure = (error: string) => action(DISCONNECT_WALLET_FAILURE, { error })

export type DisconnectWalletRequestAction = ReturnType<typeof disconnectWalletRequest>
export type DisconnectWalletSuccessAction = ReturnType<typeof disconnectWalletSuccess>
export type DisconnectWalletFailureAction = ReturnType<typeof disconnectWalletFailure>
...
export const fetchWalletSuccess = (wallet: Wallet) => action(FETCH_WALLET_SUCCESS, { wallet })
export const fetchWalletFailure = (error: string) => action(FETCH_WALLET_FAILURE, { error })
...
export const switchNetworkRequest = (chainId: ChainId, fromChainId?: ChainId) => action(SWITCH_NETWORK_REQUEST, { chainId, fromChainId })
export const switchNetworkSuccess = (chainId: ChainId) => action(SWITCH_NETWORK_SUCCESS, { chainId })
export const switchNetworkFailure = (chainId: ChainId, error: string) => action(SWITCH_NETWORK_FAILURE, { chainId, error })
...
export const setAppChainId = (chainId: ChainId) => action(SET_APP_CHAIN_ID, { chainId })
