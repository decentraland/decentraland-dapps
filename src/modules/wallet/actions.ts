...
export type SwitchNetworkRequestAction = ReturnType<
  typeof switchNetworkRequest
>;
export type SwitchNetworkSuccessAction = ReturnType<
  typeof switchNetworkSuccess
>;
export type SwitchNetworkFailureAction = ReturnType<
  typeof switchNetworkFailure
>;
