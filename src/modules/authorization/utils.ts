...
export function hasAuthorizationAndEnoughAllowance(authorizations: Authorization[], authorizationToFind: Authorization, allowance: string) {
...
export function areEqual(left: Authorization, right: Authorization) {
  return (
    ...
    left.authorizedAddress.toLowerCase() === right.authorizedAddress.toLowerCase() &&
