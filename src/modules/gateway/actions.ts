...
// Open MANA-FIAT Gateway
export const OPEN_MANA_FIAT_GATEWAY_REQUEST =
  "[Request] Open MANA-FIAT Gateway";
export const OPEN_MANA_FIAT_GATEWAY_SUCCESS =
  "[Success] Open MANA-FIAT Gateway";
export const OPEN_MANA_FIAT_GATEWAY_FAILURE =
  "[Failure] Open MANA-FIAT Gateway";
...
export const addManaPurchaseAsTransaction = (purchase: Purchase) => {
  if (!purchase.txHash) {
    throw new Error(
      `Transaction Hash is undefined for purchase ${purchase.id}`,
    );
  }
