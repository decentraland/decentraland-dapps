...
export const fetchCreditsRequest = (address: string) =>
...
export type PollCreditsBalanceRequestAction = ReturnType<
  typeof pollCreditsBalanceRequest
>
...
export const startCreditsSSE = (address: string) =>
  action(START_CREDITS_SSE, { address })
