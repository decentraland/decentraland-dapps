...
export const isFetchingCredits = (state: any): boolean => isLoadingType(getLoading(state), FETCH_CREDITS_REQUEST)

export const getCredits = (state: any, address: string) => getData(state)[address]
