...
import { ChangeLocaleAction, changeLocale } from '../../modules/translation/actions'
...
const mapDispatch = (dispatch: RootDispatch<ChangeLocaleAction>): MapDispatchProps => ({
  onChange: (_, { value }) => dispatch(changeLocale(value as Locale))
})

const mergeProps = (stateProps: MapStateProps, dispatchProps: MapDispatchProps, ownProps: FooterProps): FooterProps => ({
  ...stateProps,
  ...dispatchProps,
  ...ownProps
})
