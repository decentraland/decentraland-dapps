...
export interface AuthorisationChangedEventLog
  extends EventLog<AuthorisationChangedEvent, 'AuthorisationChanged'> {}
export interface TextChangedEventLog
  extends EventLog<TextChangedEvent, 'TextChanged'> {}
export interface PubkeyChangedEventLog
  extends EventLog<PubkeyChangedEvent, 'PubkeyChanged'> {}
export interface NameChangedEventLog
  extends EventLog<NameChangedEvent, 'NameChanged'> {}
export interface InterfaceChangedEventLog
  extends EventLog<InterfaceChangedEvent, 'InterfaceChanged'> {}
export interface DNSRecordChangedEventLog
  extends EventLog<DNSRecordChangedEvent, 'DNSRecordChanged'> {}
export interface DNSRecordDeletedEventLog
  extends EventLog<DNSRecordDeletedEvent, 'DNSRecordDeleted'> {}
export interface DNSZoneClearedEventLog
  extends EventLog<DNSZoneClearedEvent, 'DNSZoneCleared'> {}
export interface ContenthashChangedEventLog
  extends EventLog<ContenthashChangedEvent, 'ContenthashChanged'> {}
export interface AddrChangedEventLog
  extends EventLog<AddrChangedEvent, 'AddrChanged'> {}
export interface AddressChangedEventLog
  extends EventLog<AddressChangedEvent, 'AddressChanged'> {}
export interface ABIChangedEventLog
  extends EventLog<ABIChangedEvent, 'ABIChanged'> {}
...
export interface ENSResolverTransactionReceipt
...
interface ENSResolverMethods {
  ...
  setDNSRecords(
    node: string,
    data: string
  ): TxSend<ENSResolverTransactionReceipt>
  setText(
    node: string,
    key: string,
    value: string
  ...
  setAddr(
    node: string,
    coinType: number | string | BN,
    a: string
  ): TxSend<ENSResolverTransactionReceipt>
  dnsRecord(
    node: string,
    name: string,
    resource: number | string | BN
  ): TxCall<string>
...
export const ENSResolverAbi = abi
