...
export interface NewResolverEventLog
  extends EventLog<NewResolverEvent, 'NewResolver'> {}
...
export interface ENSTransactionReceipt
  extends TransactionReceipt<ENSTxEventLogs> {}
