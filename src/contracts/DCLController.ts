...
export interface MaxGasPriceChangedEventLog
  extends EventLog<MaxGasPriceChangedEvent, 'MaxGasPriceChanged'> {}
export interface NameBoughtEventLog
  extends EventLog<NameBoughtEvent, 'NameBought'> {}
...
export interface DCLControllerTransactionReceipt
  extends TransactionReceipt<DCLControllerTxEventLogs> {}
interface DCLControllerMethods {
  ...
  register(
    _name: string,
    _beneficiary: Address
  ): TxSend<DCLControllerTransactionReceipt>
