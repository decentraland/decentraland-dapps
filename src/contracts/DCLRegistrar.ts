...
export interface BaseUpdatedEventLog
  extends EventLog<BaseUpdatedEvent, 'BaseUpdated'> {}
export interface ControllerAddedEventLog
  extends EventLog<ControllerAddedEvent, 'ControllerAdded'> {}
export interface ControllerRemovedEventLog
  extends EventLog<ControllerRemovedEvent, 'ControllerRemoved'> {}
export interface DomainReclaimedEventLog
  extends EventLog<DomainReclaimedEvent, 'DomainReclaimed'> {}
export interface DomainTransferredEventLog
  extends EventLog<DomainTransferredEvent, 'DomainTransferred'> {}
export interface MigrationFinishedEventLog
  extends EventLog<MigrationFinishedEvent, 'MigrationFinished'> {}
export interface NameRegisteredEventLog
  extends EventLog<NameRegisteredEvent, 'NameRegistered'> {}
export interface OwnershipTransferredEventLog
  extends EventLog<OwnershipTransferredEvent, 'OwnershipTransferred'> {}
export interface ReclaimedEventLog
  extends EventLog<ReclaimedEvent, 'Reclaimed'> {}
export interface RegistryUpdatedEventLog
  extends EventLog<RegistryUpdatedEvent, 'RegistryUpdated'> {}
...
export interface DCLRegistrarTransactionReceipt
  extends TransactionReceipt<DCLRegistrarTxEventLogs> {}
interface DCLRegistrarMethods {
  ...
  ): TxSend<DCLRegistrarTransactionReceipt>
  ...
  migrateNames(
    ...
    _createdDates: (number | string | BN)[]
  ): TxSend<DCLRegistrarTransactionReceipt>
...
export const DCLRegistrarAbi = abi
