 ...
 * what the signer signed. Trades settle on the newest deployment, which is V3 on every chain the package
 * knows; the list stays ordered so a chain that receives an older version first still resolves.
 */
